...
#Intializing the model and class_dict globally to utilize caching across invocations
model = None 
class_dict = None
...
def predict_image_from_url(image_url):
    ...
    with urlopen(image_url) as testImage:
        ...
        predicted_idx = softmax.argmax().item()

        response = {
            'created': datetime.utcnow().isoformat(),
            'predictedTagName': class_labels[predicted_idx],
